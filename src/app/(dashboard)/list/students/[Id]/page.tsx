      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-4">
        <div className="bg-white p-4 rounded-md">
          ...
          <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
            <Link className="p-3 rounded-md  bg-Askylight" href="/">Student's Lessons</Link>
            <Link className="p-3 rounded-md  bg-Apurplelight" href="/">Student's Teachers</Link>
            <Link className="p-3 rounded-md  bg-Ayellowlight" href="/">Student's Lessons</Link>
            <Link className="p-3 rounded-md  bg-pink-50" href="/">Student's Exams</Link>
            <Link className="p-3 rounded-md  bg-Askylight" href="/">Student's Assignments</Link>
            <Link className="p-3 rounded-md  bg-Askylight" href="/">Student's Results</Link>
          </div>
        </div>
        <Performance/>
        <Announcements />
