...
const LoginPage = () => {
    return (
        <div className="h-screen flex items-center justify-center bg-Askylight">
            <SignIn.Root>
                <SignIn.Step name='start' className='bg-white p-12 rounded-md shadow-2xl flex flex-col gap-2'>
                    ...
                    {/* <div className="flex  justify-center"> _</div>
            <div className="flex  justify-center"> for Guest  User</div>
            <div className="flex  justify-center"> username= guest</div>
            <div className="flex  justify-center"> password =guest</div> */}
                </SignIn.Step>
            </SignIn.Root>
        </div>
    )
